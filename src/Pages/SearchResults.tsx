...
//   const jobs: CongViec[] = location.state || [];
...
//                   {Array.from({ length: job.saoCongViec }, (_, index) => (
//                     <FontAwesomeIcon
//                       key={index}
//                       icon={faStar}
...
//                     />
//                   ))}
//                   <span className="ml-2">({job.danhGia} đánh giá)</span>
//                 </div>
//                 <p className="text-gray-700 mb-2">{job.moTaNgan}</p>
//                 <p className="font-bold text-lg">${job.giaTien}</p>
...
//                       #{job.tenLoaiCongViec} #{job.tenNhomChiTietLoai}{" "}
//                       #{job.tenChiTietLoai}
//                     </p>
//                   </div>
//                 </div>
